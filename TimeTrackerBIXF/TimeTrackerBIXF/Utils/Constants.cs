...
namespace TimeTrackerBIXF.Utils
{
    ...
    {
        public static string WS_Url = "http://61a92187e7d34e979136e269e9067b8f.cloudapp.net/api/";
        ...
        public static string Url_Formax_GetUserInfo = WS_Url + "FormaxGetUserInfo?Email={0}";
